...
var btnDecrease = document.querySelector('#decrease'); // Define Actions
...
render(); // Update the UI in response to state changes

store.subscribe(render); // dispatch: The only way to mutate the internal state is to dispatch an action.
...
//# sourceMappingURL=/intro-redux.e31bb0bc.js.map